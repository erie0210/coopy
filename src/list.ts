...
export function setupList() {
  ...
  const $searchResultTable = document.getElementById("search-result-table") as HTMLElement;
  const $searchCheckbox = document.getElementById("search-checkbox") as HTMLInputElement;
